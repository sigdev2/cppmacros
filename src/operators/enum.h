...
#pragma once
#ifndef __HAS_CPPMACROS_ENUM_H__
#define __HAS_CPPMACROS_ENUM_H__
...
/*!
   ...
   \returns enum definition
*/
#define DEFINE_ENUM_NUM(name, ...) enum name {  PP_HEAD(__VA_ARGS__) = 0 PP_COMMA PP_TAIL(__VA_ARGS__) };
...
/////////////////////////////////////////////////////////////////////////////
#endif // __HAS_CPPMACROS_ENUM_H__